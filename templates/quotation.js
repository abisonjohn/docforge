...
5. For any other special conditions/ information's - Please see the comments column for more details.`;
    ...
    var bank = {
        table: {
            widths: ['24%', '2%', '74%'],
            body: [
                data.bank_details.account_name ? [{ text: 'Beneficiary', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.account_name, bold: true, border: [false, false, false, false] }] : undefined,
                data.bank_details.bank_name ? [{ text: 'Bank Name', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.bank_name, bold: true, border: [false, false, false, false] }] : undefined,
                data.bank_details.account_no ? [{ text: 'Bank Account No', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.account_no, bold: true, border: [false, false, false, false] }] : undefined,
                data.bank_details.branch ? [{ text: 'Bank Branch', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.branch, bold: true, border: [false, false, false, false] }] : undefined,
                data.bank_details.swift_code ? [{ text: 'Swift Code', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.swift_code, bold: true, border: [false, false, false, false] }] : undefined,
                data.bank_details.ifsc_code ? [{ text: 'IFSC Code', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.ifsc_code, bold: true, border: [false, false, false, false] }] : undefined,
                data.bank_details.bank_address ? [{ text: 'Bank Address', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.bank_address, bold: true, border: [false, false, false, false] }] : undefined,
                data.bank_details.correspondent_bank ? [{ text: 'Correspondent Bank', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.correspondent_bank, bold: true, border: [false, false, false, false] }] : undefined,
                data.bank_details.intermediary_bank ? [{ text: 'Intermediary Bank', border: [false, false, false, false] }, { text: ':', border: [false, false, false, false] }, { text: data.bank_details.intermediary_bank, bold: true, border: [false, false, false, false] }] : undefined
            ].filter(Boolean)
        },
        layout: 'noBorders'
    }
    ...
    return {
        ...
        content: [
            {
                text: 'QUOTATION', alignment: 'center', bold: true, fontSize: 10
            },
            {
                table: {
                    headerRows: 0,
                    ...
                    body: [
                        ...
                        { text: ['BIOINGREDIA NATURAL PVT LTD', { text: '\n23/1186, 3RD FLOOR, POCUDYIL PLAZA\n  PADAMUGAL, ERNAKULAM - 682030, KERALA, INDIA\nGSTIN/UIN: 32AAGCB1593G1ZW\nState Name: Kerala, Code: 32\nCIN: U74140KL2015PTC037811\nFSSAL No: 10018041001390\nUSFDA: 14300379046\nE-Mail: sales@bioingredia.com\nwww.bioingredia.com', bold: false, lineHeight: 0.9 }], border: [false, true, true, true], bold: true, fontSize: 8, rowSpan: 7, colSpan: 2 }, {}, { text: ['Quotation No: ', { text: data.DOC_NO, bold: true }], fontSize: 8 }, { text: ['Quotation Date: ', { text: formatDateToDDMONYYYY(data.DOC_DATE), bold: true }], fontSize: 8 }],
                        [{}, {}, {}, { text: [{ text: `Quotation Validity: ` }, { text: formatDateToDDMONYYYY(data.VALID_DATE), bold: true }], fontSize: 8, colSpan: 2 }, {}],
                        ...
                        [{}, {}, {}, { text: [{ text: `Lead Time: ` }, { text: data.LEAD_TIME, bold: true }], fontSize: 8, colSpan: 2 }, {}]
                    ]
                },
                layout: customLayout
            },
            ...
            },
            {
                table: {
                    ...
                    widths: ['*', '*', '*', '*'],
                    body: [
                        [{ text: 'Sales Manager', bold: true }, { text: data.default_sales_rep.name }, { text: 'Customer Service Manager', bold: true }, { text: data.customer_service_rep.name }],
                        [{ text: 'Contact Number', bold: true }, { text: data.default_sales_rep.phone }, { text: 'Contact Number', bold: true }, { text: data.customer_service_rep.phone }],
                        [{ text: 'E-Mail', bold: true }, { text: data.default_sales_rep.email }, { text: 'E-Mail', bold: true }, { text: data.customer_service_rep.email }]
                    ],
                },
                layout: customLayout
            },
            {
                table: {
                    ...
                    widths: ['*', '*'],
                    body: [
                        [{ text: [{ text: `Remarks:\n`, decoration: 'underline', bold: true }, { text: data.REMARKS }], fontSize: 8, }, bank],
                    ],
                },
                layout: customLayout
            },
